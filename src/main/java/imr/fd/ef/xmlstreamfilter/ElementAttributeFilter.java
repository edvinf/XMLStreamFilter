...
/**
 * Filters elements by attribute values.
 * Not namespace aware
 * Reading is stopped when an element of the given element name is encountered if the given attribute does not match any of the retaioned values.
 * Reading is resumed when end tag of element is reached.
